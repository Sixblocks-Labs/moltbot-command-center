...
export function Markdown({ content }: { content: string }) {
  ...
  return (
    <div className="prose prose-invert max-w-none break-words [overflow-wrap:anywhere] pr-2 prose-pre:relative prose-pre:border prose-pre:bg-muted prose-pre:p-3">
      <ReactMarkdown
